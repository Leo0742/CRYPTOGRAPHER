    ...
    def closeEvent(self, event):
        ...
        if (data[0] == "true" and (data[1] == "0" or data[2] == "0")):
            ...
            if (data[1] == "0" and data[2] == "0"):
                ...
                Report_Window.setDetailedText("Если вы хотите вернуться и скопировать ключ и вектор инициализации, нажмите OK.\n"
                ...
                Report_Window.setDetailedText("Если вы хотите вернуться и скопировать вектор инициализации, нажмите OK.\n"
