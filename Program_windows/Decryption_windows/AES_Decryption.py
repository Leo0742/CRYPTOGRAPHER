...
class Ui_Window_decr_AES(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.key_label.setGeometry(QtCore.QRect(270, 330, 341, 41))
        ...
        self.key_on_off.setGeometry(QtCore.QRect(620, 320, 61, 61))
